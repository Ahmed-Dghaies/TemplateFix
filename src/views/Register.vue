      ...
      <form name="form" @submit.prevent="handleRegister">
        <div v-if="!successful">
          ...
          <div class="form-group">
            <input
              v-model="password"
              v-validate="{ required: true, regex: /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$/, min:6, max:40 }"
              type="password"
              class="form-control"
              name="password"
          ...
          <div>
            <div class="form-group birthdate">
              ...
              />
              <i class="fa fa-birthdate-cake" aria-hidden="true"></i>
              <div
...
Validator.extend("password", {
  getMessage: field => "The " + field + " One number required.",
  validate: value => value.test(/[0-9]+/)
});
export default {
  name: "Register",
  data() {
